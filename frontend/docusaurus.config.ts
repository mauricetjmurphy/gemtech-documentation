...
const config: Config = {
  ...
  tagline: "Life saving documentation",
  ...
  organizationName: "mauricetjmurphy", // Usually your GitHub org/user name.
  projectName: "gemtech-documentation", // Usually your repo name.
